...
str_header = str(Header_decoded,'utf-8')
alg_substitute = str_header.replace(Alg,'None') #convert the bytes objects to string , to apply the string operations on it to replace the alg with none 
